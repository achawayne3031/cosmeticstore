...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9 col-xl-9 col-sm-12 col-12 offset-lg-3 offset-md-3">
            <h6 class="text-center category-title">Hair Care</h6>
            ...
            <div class="row">
                    ...
                    @foreach ($hairs as $item)
                            <div class="col-lg-3 col-lg-3 col-md-4 col-xl-3 col-sm-6 col-6 category-body">
                                <a href="/item/{{$item->id}}" class="text-black">
                                    ...
                                    <div class="col-lg-12 col-lg-12 col-md-12 col-xl-12 col-sm-12 col-12 pt-2 pl-0 pr-0">
                                        @php
                ...
                @else
                    <div class="col-lg-12">
                        <h6 class="alert alert-success text-center category-no-item">No Item On Hair Care</h6>
                    </div>
                @endif
            </div>
