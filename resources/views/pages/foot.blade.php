...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9 col-xl-9 col-sm-12 col-12 offset-sm-1 offset-lg-3 offset-md-3">
            <h6 class="text-center category-title">Foot Care</h6>
            <hr class="category-hr">
            <div class="row">
                @if(count($foots) > 0)
                    @foreach ($foots as $item)
                ...
                @else
                    <div class="col-lg-12">
                        <h6 class="alert alert-success text-center category-no-item">No Item On Foot Care</h6>
                    </div>
                @endif
            </div>
            ...
            <div class="row mt-3">
                <div class="col-lg-9 col-md-9 col-xl-9 col-sm-12 col-12 d-flex justify-content-center">
                    {{ $foots->links() }}
                </div>
            </div>
